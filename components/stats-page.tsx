...
export function StatsPage() {
  ...
  return (
    <div className="container mx-auto sm:p-4 p-0 sm:scale-100 scale-[0.65] relative sm:bottom-0 bottom-[100px]">
        ...
        <TabsContent value="overview">
          <div className="flex items-center gap-2 space-y-2">
            <Card className="w-[300px] h-[250px]">
              <CardHeader>
                <CardTitle className="text-xl">Most Wins</CardTitle>
                <CardDescription>
              ...
              <CardContent>
                {stats.mostWins.map((player, index) => (
                  <div key={index}>
                    <p
                      className={`${index === 0 ? "text-xl" : "text-lg text-gray-300"} font-bold `}
                    >
                      {player.name}
                    </p>
                    <p
                      className={`${index === 0 ? "text-lg text-white" : "text-md text-gray-300"}`}
                    >
                      {player.wins} wins
                    </p>
                  </div>
            ...
            <Card className="w-[300px] h-[250px]">
              <CardHeader>
                <CardTitle className="text-xl">Longest Win Streak</CardTitle>
                <CardDescription>
          ...
          <div className="flex items-center gap-2 space-y-2">
            <Card className="w-[300px] h-[250px]">
              <CardHeader>
                <CardTitle className="text-xl">Highest Win Rate</CardTitle>
                <CardDescription>
            ...
            <Card className="w-[300px] h-[250px]">
              <CardHeader>
                <CardTitle className="text-xl">Highest Rating</CardTitle>
                <CardDescription>
                  Players with the highest rating
                </CardDescription>
                <hr />
              </CardHeader>
              <CardContent>
